...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ($conn->query($createTableSQL) === TRUE) {
        ...
        $insertDataSQL = $conn->prepare("INSERT INTO `$projectName` (question, answeri, answerii, answeriii, answeriv, description)
                                         VALUES (?, ?, ?, ?, ?, ?)");
        $insertDataSQL->bind_param("ssssss", $question, $answeri, $answerii, $answeriii, $answeriv, $description);
